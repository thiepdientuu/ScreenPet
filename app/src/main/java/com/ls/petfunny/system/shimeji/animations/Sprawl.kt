...
internal class Sprawl(override val direction: Direction, shimejiId: Int, paidenable: Boolean, flinging: Boolean) : Animation(shimejiId, paidenable,
    flinging
) {
    ...
    override fun getSprites(): MutableList<Sprite>? {
        ...
        return when (shimejiId) {
            ...
            116 -> {
                ...
                sprites.add(Sprite(20, 0, 0, 250))//250
                sprites
            }
        }
    }
